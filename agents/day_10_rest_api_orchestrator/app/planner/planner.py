...
# Ensure repository root is on sys.path for shared imports
...
class LLMPlanner:
    ...
    async def plan(self, user_goal: str) -> ExecutionPlan:
        """
        Synthesize an ExecutionPlan from a user goal using LLM or heuristic fallback.
        """
    ...
    def _heuristic_fallback(self, user_goal: str) -> ExecutionPlan:
        """
        Heuristic rule-based fallback planner for common goal patterns.
        """
